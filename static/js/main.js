const translations = {
  tr: {
    ...
    t6Year: 'Şimdi',
    t6Title: 'Güncel Odak',
    t6Text: 'Güncel olarak VHDL dili ile FPGA alanında ilerleme katetmeye başladım.',
  ...
  en: {
    ...
    t6Text: 'Currently, I have started making progress in FPGA with VHDL language.',
